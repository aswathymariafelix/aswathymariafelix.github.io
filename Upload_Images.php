...
<div class="ver_nav">
    ...
    <a href="Upload_Images.php"><li class="active"><i class="fa fa-image"></i><span class="tooltiptext">Upload Images</span></li></a>
    <a href="Upload_Music.php"><li><i class="fa fa-music"></i><span class="tooltiptext">Upload Music</span></li></a>
    <a href="Upload_Ebooks.php"><li><i class="fa fa-book"></i><span class="tooltiptext">Upload Ebooks</span></li></a>
    <a href="login.php?logout=true"><li><i class="fa fa-download"></i><span class="tooltiptext">Logout</span></li></a>
  </ul>
</div>
<center>
<form method="POST" enctype="multipart/form-data" action="file_Images.php">
<div class="margin">
<div class="row">
	<div class="column">
	...
	<div class="column">
     ...
     <input type="submit" name="Upload File" value="Upload Image" class="upload">
 	</div>
</div>
</div>
</form>
