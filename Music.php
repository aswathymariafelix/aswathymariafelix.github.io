...
<div class="ver_nav">
  <ul>
    ...
    <a href="Music.php"><li class="active"><i class="fa fa-music"></i><span class="tooltiptext">Music</span></li></a>
...
<div class="row">
    ...
    <div class="column">
     <div class="card">
      <div class="tab">
       <div class="middle">
       	<a href="uploads/Music/<?php echo $files[$a]; ?>" class="button" download>Download</a>
       </div>
      </div>
