...
<div class="ver_nav">
 <ul>
    <a href="Movies.php"><li class="active"><i class="fa fa-film"></i><span class="tooltiptext">Movies</span></li></a>
    ...
    <a href="Ebooks.php"><li><i class="fa fa-book"></i><span class="tooltiptext">Ebooks</span></li></a>
...
<div class="row">
    ...
    <div class="column">
     <div class="card">
      <div class="tab">
       <div class="middle">
       	<a href="uploads/Movies/<?php echo $files[$a]; ?>" class="button" download>Download</a>
       </div>
      </div>
