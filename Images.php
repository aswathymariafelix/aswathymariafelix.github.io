...
<div class="ver_nav">
  <ul>
    ...
    <a href="Images.php"><li class="active"><i class="fa fa-image"></i><span class="tooltiptext">Images</span></li></a>
...
<div class="row">
    ...
    <div class="column">
     <div class="card" style="height: auto;">
      <div class="tab">
       <div class="middle">
       	<a href="uploads/Images/<?php echo $files[$a]; ?>" class="button" download>Download</a>
       </div>
      </div>
