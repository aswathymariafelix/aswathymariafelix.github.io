...
<div class="ver_nav">
    ...
    <a href="Upload_Music.php"><li class="active"><i class="fa fa-music"></i><span class="tooltiptext">Upload Music</span></li></a>
...
<center>
<form method="POST" enctype="multipart/form-data" action="file_Music.php">
<div class="margin">
<div class="row">
	<div class="column">
	...
	<div class="column">
     ...
     <input type="submit" name="Upload File" value="Upload Audio" class="upload">
 	</div>
</div>
</div>
</form>
