...
<div class="ver_nav">
	<ul>
    <a href="Upload_Movies.php"><li class="active"><i class="fa fa-film"></i><span class="tooltiptext">Upload Movies</span></li></a>
...
<center>
<form method="POST" enctype="multipart/form-data" action="file_Movies.php">
<div class="margin">
<div class="row">
	<div class="column">
	...
	<div class="column">
     ...
     <input type="submit" name="Upload File" value="Upload Movie" class="upload">
 	</div>
</div>
</div>
</form>
